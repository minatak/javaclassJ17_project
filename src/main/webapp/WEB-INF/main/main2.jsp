                    ...
                    <div class="row gx-5 align-items-center justify-content-center">
                        <div class="col-lg-8 col-xl-7 col-xxl-6">
                            <div class="my-5 text-center text-xl-start">
                                <h1 class="display-5 fw-bolder text-white mb-2">LinguaLink : Bridging Cultures Through Language</h1>
                                ...
                                <div class="d-grid gap-3 d-sm-flex justify-content-sm-center justify-content-xl-start">
                                    <a class="btn btn-primary btn-lg px-4 me-sm-3" href="#features">지금 가입하기</a>
                        ...
                        <div class="col-lg-10 col-xl-7">
                            <div class="text-center">
                                ...
                                <div class="d-flex align-items-center justify-content-center">
                                    <img class="rounded-circle me-3" src="${ctp}/images/Wittgenstein.jpeg" /> <!-- 40 x 40 픽셀로 사이즈 변경하기 -->
                                    <div class="fw-bold">
                                        Ludwig Wittgenstein
