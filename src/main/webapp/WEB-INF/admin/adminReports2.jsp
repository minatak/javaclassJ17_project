        ...
        <form name="myform">
	        <c:forEach var="vo" items="${vos}" varStatus="st">
	          <tr>
	            ...
	            <td>
	              <a href="#" class="info" onclick="modalCheck('${vo.mid}', '${vo.nickName}', '${vo.name}', '${vo.email}', '${vo.gender}', '${fn:substring(vo.birthday, 0, 10)}', '${vo.startDate}')" data-toggle="modal" data-target="#myModal">${vo.mid}</a>
	            </td>
