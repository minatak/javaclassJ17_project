...
<body>
  ...
  <main class="container">
    ...
    <div class="card">
      <form name="myform" action="VocaEditOk.st" method="POST">
        <div class="input-group">
          <input type="text" name="category" id="category" class="form-control name-input" value="${category}" />
            	...
            	<c:set var="count" value="1" />
            	  <c:forEach var="vo" items="${vos}" varStatus="st">
			            <tr>
			              ...
			              <td style="width: 30%;"><input type="text" name="words[]" placeholder="단어" value="${vo.word}" required></td>
			              <c:if test="${!empty vo.partOfSpeech}"><td style="width: 70%;"><input type="text" name="meanings[]" value="${vo.partOfSpeech}) ${vo.meaning}" placeholder="뜻"></td></c:if>
			              <c:if test="${empty vo.partOfSpeech}"><td style="width: 70%;"><input type="text" name="meanings[]" value="${vo.meaning}" placeholder="뜻"></td></c:if>
    ...
    <p><br/></p>
          ...
          <div class="test-section" style="text-align: center;">
            <a onclick="fCheck()" class="btnTest mr-1">수정하기</a>
